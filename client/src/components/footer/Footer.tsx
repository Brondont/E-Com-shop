...
const Footer: React.FC = () => {
  ...
  return (
    ...
    >
      <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", color: "primary.contrastText", gap: "30px", p: 4, flexWrap: "wrap" }}>
        ...
        <Box sx={{
          ...
          <TextField size="small" label="Your e-mail" variant="filled" fullWidth color="secondary" />
          <Button variant="contained" size="small" color="secondary">Sign up</Button>
        </Box>
        <Button color="secondary" size="large" onClick={scrollUp}>Back to the top <ArrowUpwardIcon sx={{ ml: 1 }} /></Button>
      </Box>
      <Divider />
      <Box sx={{
        display: "flex",
        ...
        <Box sx={{ mb: 2 }}>
          ...
          <Typography variant="body2" sx={{ mb: 1 }}>
            <Link href="https://www.twitter.com" target="_blank" color="inherit" underline="hover">
              Twitter
            </Link>
          </Typography>
          <Typography variant="body2">
